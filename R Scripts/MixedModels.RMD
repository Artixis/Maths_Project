...
================================================================================
Try the same model as above with Parramatta as our main point of reference. 
================================================================================
...
df_parra = expand.grid(logsydist=c(0.6899496, 0.8246439, 2.3740355, 4.517657, 4.176942), yearsince2000=1.0:21.0)
...
```{r}
df_predict_parra = predict(slopes_years_syd, df_parra, re.form=~0)
...
```{r}
int_eff = ranef(intercepts_years)$name
int_coef = coef(intercepts_years)$name
```


```{r}
greaterSyd$coef <- int_coef$`(Intercept)`[match(unique(greaterSyd$SA2_NAME16),row.names(int_coef))]
